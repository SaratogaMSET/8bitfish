 ...
 *
 */
public class RightMPSwitchDouble extends CommandGroup {

    public RightMPSwitchDouble() {
        ...
        addSequential(new DrivetrainMotionProfileIn(-20));
        ...
        addSequential(new DrivetrainMotionProfileIn(-40));
        addSequential(new GyroPID(-45));
        addSequential(new SetIntakePistons(false, true));
        addSequential(new DrivetrainMotionProfileIn(45));
        addSequential(new RunIntakeForTime(0.5, true, 1));
