...
public class EncoderTurn extends Command {
    ...
    protected void initialize() {
    	...
    	converted = Robot.drive.getTranslationDistance(angle);
		...
		SmartDashboard.putString("Current Command", getName() + angle);
...
//		}
    ...
    protected void end() {
    	SmartDashboard.putNumber("Encoder Turn", Robot.drive.motors[0].getSelectedSensorPosition(0));
